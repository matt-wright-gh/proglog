...
func (x *ConsumeResposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConsumeResposne) ProtoMessage() {}

func (x *ConsumeResposne) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_log_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConsumeResposne.ProtoReflect.Descriptor instead.
func (*ConsumeResposne) Descriptor() ([]byte, []int) {
	return file_api_v1_log_proto_rawDescGZIP(), []int{4}
}

func (x *ConsumeResposne) GetRecord() *Record {
	if x != nil {
		return x.Record
	}
	return nil
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x6e, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65,
	...
	0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e,
	0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65,
	...
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x61, 0x74, 0x74, 0x2d, 0x77,
	0x72, 0x69, 0x67, 0x68, 0x74, 0x2d, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67,
...
var file_api_v1_log_proto_goTypes = []interface{}{
	...
	(*ConsumeResposne)(nil), // 4: log.v1.ConsumeResposne
}
var file_api_v1_log_proto_depIdxs = []int32{
	0, // 0: log.v1.ProduceRequest.record:type_name -> log.v1.Record
	0, // 1: log.v1.ConsumeResposne.record:type_name -> log.v1.Record
	...
	4, // 8: log.v1.Log.ConsumeStream:output_type -> log.v1.ConsumeResposne
